...
/// <summary>
/// Cart-page upsell: upgrade alternatives for everything currently in the cart, scored by how
/// many distinct cart lines recommend each candidate, excluding anything already in the cart.
/// </summary>
public class GetCartUpSellQueryHandler : IQueryHandler<GetCartUpSellQuery, IReadOnlyList<ProductPublicDto>>
{
    ...
    public GetCartUpSellQueryHandler(
    ...
    public async Task<Result<IReadOnlyList<ProductPublicDto>>> Handle(
        GetCartUpSellQuery request, CancellationToken ct)
    {
