...
public class RemoveMerchantFromStoreCommandHandler : ICommandHandler<RemoveMerchantFromStoreCommand>
{
    private readonly IMerchantRepository _merchantRepository;
    private readonly ICurrentUserService _currentUserService;

    public RemoveMerchantFromStoreCommandHandler(
    ...
    public async Task<Result> Handle(RemoveMerchantFromStoreCommand request, CancellationToken cancellationToken)
    {
        ...
        if (!targetMerchant.HasAccessToStore(storeId))
