...
public class GetStorefrontPagesQueryHandler : IQueryHandler<GetStorefrontPagesQuery, List<PageConfigurationDto>>
{
    private readonly IPageConfigurationRepository _repository;

    public GetStorefrontPagesQueryHandler(IPageConfigurationRepository repository)
    {
        _repository = repository;
    }

    public async Task<Result<List<PageConfigurationDto>>> Handle(
        GetStorefrontPagesQuery query,
