      ...
      <section class="bg-gradient-to-r from-primary/10 to-primary/5 py-16 md:py-24">
        <div class="container mx-auto px-4">
          <div class="max-w-3xl mx-auto text-center">
            ...
            <a
              [routerLink]="['/products']"
              class="inline-block px-8 py-4 bg-primary text-white rounded-lg hover:bg-primary-dark transition-colors font-semibold text-lg"
            >
              Shop Now
            </a>
          </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
              @for (category of categories(); track category.id) {
                <a
                  ...
                  class="group p-6 border-2 border-gray-200 rounded-xl hover:border-primary hover:shadow-lg transition-all text-center"
                >
